ALTER TABLE public.contratos ALTER COLUMN frequencia_semanal DROP NOT NULL;
ALTER TABLE public.contratos ALTER COLUMN creditos_total DROP NOT NULL;
...
BEGIN
  ...
  -- Ciclo de crédito inicial (planos de Corrida não têm controle de créditos)
