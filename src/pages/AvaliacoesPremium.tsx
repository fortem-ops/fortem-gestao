...
export default function AvaliacoesPremium() {
  ...
  const mobilidadeLayerFilter: "mobility" | "flexibility" = layer === "flexibility" ? "flexibility" : "mobility";
  ...
  const scores = useMemo(
    () =>
      data
        ...
        : null,
    [data, funcionalDaData, composicaoDaData, sexoAluno, mobilidadeRef, faixaAluno],
  );
