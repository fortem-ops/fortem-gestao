...
import { Settings, Users, CreditCard, Briefcase, ClipboardList, Dumbbell, Activity, ShieldCheck } from "lucide-react";
...
import { AdminIntegracoes } from "@/components/admin/AdminIntegracoes";
...
const allTabs = [
  ...
  { value: "integracoes", label: "Integrações", icon: ShieldCheck, adminOnly: true },
];
      ...
      <Tabs defaultValue={defaultTab} className="w-full">
        ...
        {isAdmin && (
          <>
            ...
            <TabsContent value="integracoes" className="mt-4"><AdminIntegracoes /></TabsContent>
