...
const PagamentoLink = lazyWithReload(() => import("./pages/PagamentoLink"));
          ...
          <Routes>
            ...
            >
              ...
              >
                ...
                <Route path="tecnicos" element={<Suspense fallback={<RouteFallback />}><RelatoriosTecnicos /></Suspense>} />
