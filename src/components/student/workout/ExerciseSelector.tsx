...
// Map workout template category codes to Banco grupo names
const CODE_TO_GRUPO: Record<string, string> = {
...
// Optional: refine by subcategoria for Força codes
const CODE_TO_SUBCATEGORIA: Record<string, string | undefined> = {
